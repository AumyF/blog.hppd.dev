...
export type FileFieldsEnum =
  ...
  | "childMdx___fields___relativeDir"
  | "childMdx___id"
...
export type SiteSiteMetadataFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  description?: Maybe<StringQueryOperatorInput>;
  domainName?: Maybe<StringQueryOperatorInput>;
};
...
export type GatsbyNodeQuery = {
  allMdx: {
    allTags: MdxConnection["distinct"];
    allYears: MdxConnection["distinct"];
    allMonthes: MdxConnection["distinct"];
    allFilenames: MdxConnection["distinct"];
  } & {
    edges: Array<{
      node: Pick<Mdx, "id"> & { fields?: Maybe<Pick<MdxFields, "path">> };
    }>;
  };
};
...
export type IndexQuery = {
  allMdx: {
    nodes: Array<
      Pick<Mdx, "id" | "excerpt"> & {
        frontmatter?: Maybe<Pick<MdxFrontmatter, "title" | "tags">>;
        fields?: Maybe<Pick<MdxFields, "path" | "yyyymmdd">>;
      }
    >;
  };
};
  ...
  allMdx: {
    group: Array<
      Pick<MdxGroupConnection, "fieldValue" | "totalCount"> & {
        nodes: Array<
          Pick<Mdx, "excerpt" | "id"> & {
            frontmatter?: Maybe<Pick<MdxFrontmatter, "tags" | "title">>;
            fields?: Maybe<Pick<MdxFields, "path" | "yyyymmdd">>;
          }
        >;
      }
...
export type UseSiteQueryVariables = {};

export type UseSiteQuery = {
  site?: Maybe<
    Pick<Site, "buildTime"> & {
      siteMetadata?: Maybe<
        Pick<SiteSiteMetadata, "title" | "description" | "domainName">
      >;
    }
  >;
};
...
export type ArchiveMonthTemplateQuery = {
  allMdx: {
    nodes: Array<
      Pick<Mdx, "id" | "excerpt"> & {
        frontmatter?: Maybe<Pick<MdxFrontmatter, "title" | "tags">>;
...
export type ArchiveYearTemplateQuery = {
  allMdx: {
    nodes: Array<
      Pick<Mdx, "id" | "excerpt"> & {
        frontmatter?: Maybe<Pick<MdxFrontmatter, "title" | "tags">>;
...
export type BlogPostQuery = {
  mdx?: Maybe<
    Pick<Mdx, "tableOfContents" | "body" | "excerpt"> & {
      frontmatter?: Maybe<Pick<MdxFrontmatter, "title" | "tags">>;
      fields?: Maybe<Pick<MdxFields, "path" | "relativeDir">>;
    }
  >;
};
...
export type TagPageTemplateQuery = {
  allMdx: {
    nodes: Array<
      Pick<Mdx, "excerpt"> & {
        frontmatter?: Maybe<Pick<MdxFrontmatter, "title" | "tags">>;
